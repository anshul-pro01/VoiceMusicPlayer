...
public class SmartPlayerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pausePlay=findViewById(R.id.play_pause_btn);
                ...
                if(matchesFound!=null){
                   if(mode.equals("ON")){
                       ...
                       if(keeper.equals("pause the song")|| keeper.equals("pause") || keeper.equals("stop")){
                           playPauseSong();
                           Toast.makeText(SmartPlayerActivity.this, keeper, Toast.LENGTH_LONG).show();
                       }
                       else if(keeper.equals("play the song")|| keeper.equals("play") || keeper.equals("start")){
                           playPauseSong();
                           Toast.makeText(SmartPlayerActivity.this, keeper, Toast.LENGTH_LONG).show();
                       }
                       else if(keeper.equals("play next song")|| keeper.equals("play next") || keeper.equals("start next")){
                           playNextSong();
                           Toast.makeText(SmartPlayerActivity.this, keeper, Toast.LENGTH_LONG).show();
                       }
                       else if(keeper.equals("play previous song")|| keeper.equals("play previous") || keeper.equals("start previous")){
                           playPreviousSong();
                           Toast.makeText(SmartPlayerActivity.this, keeper, Toast.LENGTH_LONG).show();
                       }
                   }
